$(document).ready(function() {
    ...
    var myswiper = new Swiper('.swiper-container', {
        ...
        onSlideChangeEnd: function(swiper) {
            ...
            } else if ($("#seventh").hasClass("swiper-slide-active")) {
                removeClassWrap()
                $("#main_wrapper").addClass("active_7")
            } else if ($("#eighth").hasClass("swiper-slide-active")) {
                removeClassWrap()
                $("#main_wrapper").addClass("active_8")
                $('.child9tab_2').css("visibility", "hidden").hide();
                $('.child9tab_1').css("visibility", "visible").show();
            } else if ($("#ninth").hasClass("swiper-slide-active")) {
                removeClassWrap()
                $("#main_wrapper").addClass("active_9")
            }
            console.log("end")
        }
    });
    ...
    if (localStorage.goToSlide == 2 - 8) {
        myswiper.slideTo(1, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 9) {
        myswiper.slideTo(2, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 10) {
        myswiper.slideTo(3, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 11) {
        myswiper.slideTo(4, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 12) {
        myswiper.slideTo(5, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 13) {
        myswiper.slideTo(6, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 14) {
        myswiper.slideTo(7, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 15) {
        myswiper.slideTo(8, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 16) {
    ...
    //child6tab_2btn //
    $('.child9tab_2btn').bind(clickHandler, function() {
        $('.child9tab_2').css("visibility", "visible").show();
        $('.child9tab_1').css("visibility", "hidden").hide();
    });
    $('.child9tab_1btn').bind(clickHandler, function() {
        $('.child9tab_2').css("visibility", "hidden").hide();
        $('.child9tab_1').css("visibility", "visible").show();
    });
    //child4tab_2btn End//
