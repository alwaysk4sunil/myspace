...
var clickHandler = 'tap';
    ...
    $('#ckd-btn6,#ckd-btn6_d').on(clickHandler, function() {
        localStorage.setItem("goToSlide", 2 - 5);
        parent.loadPageFromChildPage(4);
    })
    $('#ckd-btn7,#ckd-btn7_d').on(clickHandler, function() {
        localStorage.setItem("goToSlide", 2 - 6);
        parent.loadPageFromChildPage(4);
    })
    $('#ckd-btn8,#ckd-btn8_d').on(clickHandler, function() {
...
// INternal Localhost
    $('#ckd-btn6_d0').on(clickHandler, function() {
        localStorage.setItem("goToSlide", 2 - 44);
        parent.loadPageFromChildPage(4);
    })
    // LOCALHOST WORKS HERE
    if (localStorage.goToSlide == 3 - 5) {
        myswiper.slideTo(0, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 3 - 6) {
        myswiper.slideTo(1, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 3 - 7) {
        myswiper.slideTo(2, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 3 - 8) {
