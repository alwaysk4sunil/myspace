$(document).ready(function() {
    ...
    $('#std-btn0,.std-btn0').on(clickHandler, function() {
    ...
    $('#ckd-btn2').on(clickHandler, function() {
        localStorage.setItem("goToSlide", 2 - 2);
        parent.loadPageFromChildPage(3);
    })
    $('#ckd-btn3').on(clickHandler, function() {
        localStorage.setItem("goToSlide", 2 - 3);
        parent.loadPageFromChildPage(3);
    })
...
// LOCALHOST WORKS HERE
    if (localStorage.goToSlide == 1 - 1) {
        myswiper.slideTo(1, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 1 - 2) {
        myswiper.slideTo(2, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 1 - 3) {
        myswiper.slideTo(3, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 1 - 4) {
