$(document).ready(function() {
    ...
    $('#cia-btn6,#cia-btn6_d').on(clickHandler, function() {
        localStorage.setItem("goToSlide", 3 - 6);
        parent.loadPageFromChildPage(6);
    })
    $('#cia-btn7,#cia-btn7_d').on(clickHandler, function() {
        localStorage.setItem("goToSlide", 3 - 7);
        parent.loadPageFromChildPage(6);
    })
    $('#cia-btn8,#cia-btn8_d').on(clickHandler, function() {
    ...
    $('#cia-btn5_d').on(clickHandler, function() {
            localStorage.setItem("goToSlide", 3 - 5);
            parent.loadPageFromChildPage(6);
        })
        // LOCALHOST WORKS HERE
    if (localStorage.goToSlide == 2 - 44) {
        myswiper.slideTo(0, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 5) {
        myswiper.slideTo(1, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 6) {
        myswiper.slideTo(2, 0)
        localStorage.removeItem('goToSlide')
    }
    if (localStorage.goToSlide == 2 - 7) {
    ...
    //child3tab_btn Script //
    $('.child3_btn1').bind(clickHandler, function() {
        removeActive()
        $(this).addClass("active");
        $(".tab_content1").show();
        $('.tabch3').css("left", "56px");
    });
    $('.child3_btn2').bind(clickHandler, function() {
        removeActive()
        $(this).addClass("active");
        $(".tab_content2").show();
        $('.tabch3').css("left", "56px");
    });
    $('.child3_btn3').bind(clickHandler, function() {
        removeActive()
        $(this).addClass("active");
        $(".tab_content3").show();
        $('.tabch3').css("left", "56px");
    });
    $('.child3_btn4').bind(clickHandler, function() {
        removeActive()
        $(this).addClass("active");
        $(".tab_content4").show();
        $('.tabch3').css("left", "56px");
    ...
    function removeActive() {
        $('.tabch3').removeClass("active");
        $(".c_hide").hide();
        $('.tabch4').removeClass("active");
        $(".d_hide").hide();
    ...
    //child3tab_3btn Script-End//

    //child4tab_btn Script //
    $('.child4tab_1btn').bind(clickHandler, function() {
        removeActive()
        $(this).addClass("active");
        $(".child4tab_1").delay("fast").fadeIn();
    });
    $('.child4tab_2btn').bind(clickHandler, function() {
        removeActive()
        $(this).addClass("active");
        $(".child4tab_2").delay("fast").fadeIn();
    });
